    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {[
          ...
          <button
            ...
            className="rounded-lg shadow-panel bg-ws-surface overflow-hidden px-3 py-3 text-left hover:border-ws-mid hover:bg-ws-paper transition-colors min-h-touch"
          >
      ...
      <div className="rounded-lg shadow-panel bg-ws-surface overflow-hidden">
        <div className="px-3 py-2 bg-ws-tick border-b border-ws-rule">
          ...
          <span className="text-[12px] text-ws-mid block mt-0.5">{later.length} further possession{later.length === 1 ? '' : 's'}</span>
        </div>
        {later.length === 0 ? (
